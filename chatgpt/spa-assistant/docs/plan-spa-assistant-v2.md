...
**Spec:** `docs/spec-spa-assistant.md`
...
- [ ] **1.0 Create system prompt**
  ...
  - [ ] 1.4 Validation: Review system prompt covers all spec requirements from `docs/spec-spa-assistant.md:262-275`
...
- `docs/spec-spa-assistant.md`: Main specification with requirements, UX flow, and acceptance criteria
- `review-spa-assistant.md`: Detailed review with specific issues and line numbers
- `docs/playbooks/spa-playbooks.md`: v1 playbooks (reference for content, not structure)
- `docs/knowledge/market-benchmarks.md`: v1 benchmarks (reference for data, fix citations)
- `docs/research-02-key-financial-definitions.md`: Domain knowledge for Playbook 1
- `docs/research-03-purchase-price-mechanics.md`: Domain knowledge for Playbook 2
- `docs/research-05-earnouts.md`: Domain knowledge for Playbook 4
- `docs/research-08-redline-comparison.md`: Domain knowledge for Playbook 7
- `docs/research-09-negotiation-roleplay.md`: Domain knowledge for Playbook 8
...
- **Playbook 1 (Definitions)**: `docs/research-02-key-financial-definitions.md` — Copy the inclusions/exclusions/red flags
- **Playbook 2 (Purchase Price)**: `docs/research-03-purchase-price-mechanics.md` — Use the price bridge format
- **Playbook 3 (WC/Net Debt)**: `docs/research-04-working-capital-vs-net-debt.md` — Use the bucket mapping approach
- **Playbook 4 (Earnouts)**: `docs/research-05-earnouts.md` — Use the metrics taxonomy and dispute risks
- **Playbook 5 (R&W)**: `docs/research-06-reps-and-warranties.md` — Use the qualifier analysis
- **Playbook 6 (Commercial Terms)**: `docs/research-07-key-commercial-terms.md` — Use the 20-term extraction list
- **Playbook 7 (Redline)**: `docs/research-08-redline-comparison.md` — Use the three-layer format
- **Playbook 8 (Roleplay)**: `docs/research-09-negotiation-roleplay.md` — Use the standard arguments by topic
