...
### Business Overview (`business_overview`)
- (scope.460) Gain an understanding of the product and service portfolio, customer segments, and go-to-market channels.
- (scope.461) Understand network/infrastructure model (owned vs leased) and key third-party dependencies.
- (scope.462) Understand key commercial arrangements (carriers/partners, wholesale, roaming, etc.) where applicable.

### Revenue Analysis (`revenue_analysis`)
- (scope.463) Analyze revenue trends by product line and customer segment, including recurring vs usage-based components.
- (scope.464) Assess churn, ARPU, net adds, retention, and other subscriber/customer KPIs where available.
- (scope.465) Understand pricing, discounting, promotions, and contract terms driving revenue sustainability.

### Capital Expenditure Requirements (`capital_expenditure_requirements`)
- (scope.466) Assess capex intensity and planned network/infrastructure investments.
- (scope.467) Understand timing and drivers of capex programs and any deferral/backlog dynamics.
- (scope.468) Review lease-versus-buy considerations for infrastructure and related cash flow impacts.

### Commitments And Contingencies (`commitments_and_contingencies`)
- (scope.469) Review key long-term commitments (network leases, tower/site leases, capacity commitments, vendor agreements).
- (scope.470) Assess regulatory and licensing exposure (including spectrum-related commitments if applicable).
- (scope.471) Review material customer credits, service-level penalties, and dispute exposure.
