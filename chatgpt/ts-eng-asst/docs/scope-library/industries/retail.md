...
### Business Overview (`business_overview`)
- (scope.420) Gain an understanding of the retail model and channels (stores, eCommerce, wholesale, etc.), including store footprint and geographic mix.
- (scope.421) Understand merchandising strategy, product/category mix, seasonality, and promotional cadence.
- (scope.422) Understand key vendors, sourcing model, and supply chain / distribution network.

### Revenue Analysis (`revenue_analysis`)
- (scope.423) Analyze revenue and gross margin trends by channel and major product category.
- (scope.424) Analyze price-volume-mix drivers including promotional activity, markdowns, returns, and discounting.
- (scope.425) Assess customer metrics where available (traffic, conversion, basket size, repeat rate/loyalty).

### Operating Expenses (`operating_expenses`)
- (scope.426) Understand store labor model and scheduling, including wage rates, staffing levels, turnover, and overtime.
- (scope.427) Review occupancy costs (rent, CAM, utilities) and store-level profitability drivers.
- (scope.428) Understand marketing and fulfillment costs (including shipping, last-mile, and returns processing).

### Working Capital (`working_capital`)
- (scope.429) Analyze inventory turns, aged inventory, stock availability, and shrink/obsolescence trends.
- (scope.430) Review vendor terms, rebates/allowances, and accounts payable practices.
- (scope.431) Assess customer liabilities and other working capital items (gift cards, loyalty liabilities, customer deposits).

### Inventory (`inventory`)
- (scope.432) Obtain and read an analysis of inventory and inquire and comment on:
