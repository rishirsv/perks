...
### Business Overview (`business_overview`)
- (scope.472) Gain an understanding of product lines, programs, customers (OEM/tier relationships), and regulatory/quality requirements.
- (scope.473) Understand backlog, program life cycles, and ramp/production cadence.
- (scope.474) Understand manufacturing footprint, capacity constraints, and supply chain dependencies.

### Revenue Analysis (`revenue_analysis`)
- (scope.475) Analyze revenue and gross margin trends by program, customer, and product line.
- (scope.476) Understand contract structures (long-term agreements, pricing escalators, penalties/claims) and revenue recognition approach.
- (scope.477) Assess customer concentration, order volatility, and backlog conversion assumptions.

### Inventory (`inventory`)
- (scope.478) Obtain and read an analysis of inventory/WIP and inquire and comment on:
...
### Capital Expenditure Requirements (`capital_expenditure_requirements`)
- (scope.479) Understand capex requirements for tooling, equipment, and capacity expansion.
- (scope.480) Assess maintenance capex versus growth capex and related replacement cycles.
- (scope.481) Review capitalized development/tooling costs (if applicable) and impairment considerations.
