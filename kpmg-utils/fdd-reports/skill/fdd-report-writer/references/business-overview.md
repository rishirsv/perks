...
- Business snapshot and perimeter
  - Cover what the Company is, what is in scope, and the basic perimeter boundary, usually in 1-3 opening bullets.
...
- Recent changes relevant to the current model
  - Add when acquisitions, restructurings, launches, closures, or other changes are needed to explain the business as it exists today.
- Comparability or standalone considerations
  - Add when historical structure, allocations, carve-outs, or TSA-type dependencies affect comparability or standalone interpretation.
...
- Comparability or standalone context, such as historical perimeter differences, allocations, carve-out mechanics, or post-close dependencies, when relevant
...
- Use a short opening line or pair of bullets to identify the Company, what it does at a high level, and the transaction perimeter.
...
- Explain how revenue is generated and which commercial mechanics matter.
- Add contract structure, pricing logic, customer type, or volume drivers only when they help the reader understand the model.
- Sample wording: `Revenue is generated through a mix of capitated contracts, fee-for-service billings, and employer-paid occupational health programs.`

### Business mix

- Use when: different parts of the business carry meaningfully different economics, roles, or growth drivers.
- Skip when: the mix detail does not change how the business model should be understood.
- Sample wording: `Core clinic visits represented approximately 68% of FY24 revenue, diagnostics represented 22%, and employer programs represented 10%, resulting in different margin and utilization dynamics across the platform.`

### Scale and footprint

- Add a concise operating metric when it makes the business model more concrete.
- Sample wording: `As of December 31, 2024, the Group operated 26 clinics, four lab sites, and served approximately 210,000 active patients.`
...
- Use when: acquisitions, restructurings, launches, closures, or pricing changes altered the current business model.
- Skip when: the change is only historical background and does not help explain the current business.
- Sample wording: `Between FY23 and FY24, the Group added six clinics through acquisition, increasing urban density and expanding the diagnostics referral base.`

### Comparability and standalone context

- Use when: shared functions, holdco allocations, carve-outs, or post-close redesign could affect interpretation of the current or historical business.
- Skip when: there is no real historical-versus-current or group-versus-standalone issue to explain.
- Sample wording: `Historical clinic profitability by legal entity is not fully comparable because corporate overhead and physician recruitment costs were managed centrally and allocated after period-end.`
