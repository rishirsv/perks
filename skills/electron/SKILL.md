---
name: electron
description: Use when the user needs to automate an Electron desktop app through agent-browser and Chrome DevTools Protocol, including connecting to a running app, interacting with UI, or testing workflows.
---
