...
5. Sample problem: Ifthe ocular has a 10x lens and the objective has a 45x lens the total
...
2. When changing from scanning to low power the field ofview gets smaller. In fact,every
...
- 2. Click the nosepiece to the lowest (shortest) setting, the scanning objective lens or4x.
- 3. Look into the eyepiecee
