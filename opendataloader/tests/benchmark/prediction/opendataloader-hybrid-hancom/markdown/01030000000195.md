...
The contributionsof this study are as follows:
...
model into diverse range ofproducts and ser-
...
models like Llama2 and Mistral 7B in reason-
ing, mathematics, and the MMLU framework.

Advancement in Instruction-Following Ca-
pabilities: The introduction OfSOLAR 10.7B-
...
capabilities ofLLMs, not evident in smaller mod-
els, are referred to as Emergent abilities (Weietal.,
2022a).

# B.2 Mixture of Experts

In the landscape of machine learning architectures,
the MixtureofExperts (MoE) models like (Shazeer
...
constraints are aconsideration (Shazeeretal.,2017;
Komatsuzaki et al., 2022).

However, efficient implementation ofMoE mod-
els poses aconsiderable challenge, primarily due to
...
tuning, adding layer of complexity to the imple-
mentation of MoE models, potentially offsetting
theiradvantages. Given the formidable challenges
...
acteristic ofMoE models, the DUS method intro-
