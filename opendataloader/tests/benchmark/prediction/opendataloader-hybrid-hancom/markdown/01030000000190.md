...
- Table 6: Performance comparison amongst the merge candidates. *Cand. 1' and *Cand. 22 are trained using the
same setting as 'DPO v2' and 'DPO v3', respectively, but with slightly different hyper-parameters. The best scores
forH6and the individual tasks are shown in bold.

|Model|Merge Method|H6(Avg.))|ARC|HellaSwag|MMLU|TruthfulQA|Winogrande|GSM8K|
|---|---|---|---|---|---|---|---|---|
|Mergevv|Average(0.5,0.5)|74.00|71.16|88.01|66.14|71.71|82.08|64.90|
|Mergevv|Average(0.4.006))|73.93|71.08|88.08|66.27|71.89|81.77|64.52|
|Mergevv|Average(0.6.0.4)|74.05|71.08|87.88|66.13|71.61|82.08|65.50|
|Mergevv|SLERP|73.96|71.16|88.03|66.25|71.79|81.93|64.59|


- Table 7: Ablation studies on the different merge methods used for obtaining the final model. We use *Cand. 1'
and *Cand. 22 from Tab. 6 as our two models for merging. We name the merged models with the *Merge* prefixto
...
DPPVV1+v2 scores 73.21 in H6, which is worse
...
datasets for this ablation. Each ofthe ablated mod-
...
*Cand. 22 using the same training dataset and SFT
base model as 'DPO v2' and 'DPOv3' but with dif-
ferent hyper-parameters to maximize each model's
respective strengths. We compare *Cand. 1' and
*Cand. 22 in Tab. 6where we can see that *Cand. 1'
has high GSM8K scores but relatively low scores
for the other tasks, whereas *Cand. 22 has low
...
1' and *Cand. 22 when averaging weights and 2)
...
individual tasks also do not differby much, suggest-
...
Llama2, Mistral 7B, and Mixtral-7B-Instruct in es-
