Lime isrecommended ifpH<5.8

# Target pH of5.5

# [6,405 (1,590 X buffer pH) 十 (98 X buffer pH X buffer pH)] X depth

Depth is in inches

Usedifcash flow is limited or in lime availability problem areas in Central and Western Kansas

Limeis recommended ifpH < 5.5
...
10 ml of the SMP buffer solution, and stir with agglas rod. Allow the mixtures to stand for 30 minutes, which should be
...
- 2. Weigh 20 gof air-dry soil into each plastic bag.
...
130 I Soil Acidity and Adjusting Soil pH
