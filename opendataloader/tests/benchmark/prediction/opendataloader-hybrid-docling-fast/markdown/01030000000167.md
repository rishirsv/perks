The acidic cations adsorbed on the negative exchange sites are called the reserve (also residual or potential) and saltreplaceable (also exchangeable) acidity. The reserve and salt-replaceable acidity controls the level of soluble or active acidity in the soil solution. Only the active acidity is measured in a routine pH determination. The reserve and saltreplaceable acidity is always many times higher than the active acidity.
