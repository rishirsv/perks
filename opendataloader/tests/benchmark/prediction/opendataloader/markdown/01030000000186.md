...
our hardware constraints and the efficiency of the scaled model, i.e., fitting between 7 and 13 billion parameters. Naturally, this leads to the removal of

- m = 8 layers. The depthwise scaling process with
- n = 32,s = 48, and m = 8 is depicted in ‘Step 1: Depthwise Scaling’ of Fig. 1.
