...
15\frac{\mathrm{cmol}_{\mathrm{c}}}{\mathrm{kg}}\times20\%\text{increase}=3\frac{\mathrm{cmol}_{\mathrm{c}}}{\mathrm{kg}}\text{basiccationsrequiredfromlime}

40\frac{\mathrm{cmol}_{\mathrm{c}}}{\mathrm{kg}}\times20\%\text{increase}=8\frac{\mathrm{cmol}_{\mathrm{c}}}{\mathrm{kg}}\text{basiccationsrequiredfromlime}
