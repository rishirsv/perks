...
\pm0.d_1d_2\ldotsd_n\cdot\beta^e\text{,}

(1.1)

in which, by definition, d1 > 0 and 0 ≤ di < β. The normalization is needed in order to prevent a
waste of digits and to make the representation unambiguous. We call the value in equation (1.1)
a floating point number (representation) in which 0.d1d2 . . . dn is called the mantissa, β the base and
...
0.d_1\ldotsd_n\cdot\beta^e\leqx<0.d_1d_2\ldots\left(d_n+1\right)\cdot\beta^e\text{,}
