...
# List of specific files — single JVM invocation
opendataloader_pdf.convert(
...
```bash
# Multiple files
opendataloader-pdf report1.pdf report2.pdf report3.pdf --format json,markdown --output-dir output/

# Directory
opendataloader-pdf ./documents/ --format json,markdown --output-dir output/
```
