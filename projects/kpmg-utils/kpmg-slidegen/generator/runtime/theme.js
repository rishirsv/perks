...
function buildColorMap(tokens = {}, overrides = {}) {
  ...
  return {
    ...
    kpmgBlueDark: firstNonEmptyString(explicit.kpmgBlueDark, defaults.kpmgBlueDark),
    kpmgBlueMid: firstNonEmptyString(explicit.kpmgBlueMid, defaults.kpmgBlueMid),
    kpmgBlueBright: firstNonEmptyString(explicit.kpmgBlueBright, primary, defaults.kpmgBlueBright),
